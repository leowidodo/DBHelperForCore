...
namespace DBHelperForCore
{
    public class DBHelper
    {
        ...
        public DBHelper(string connString)
        {
            ...
            conString = "";
            conString = new ConfigurationBuilder().AddJsonFile("appsettings.json").Build().GetSection("ConnectionStrings")[connString];//this.Configuration.GetConnectionString(AppName);  //Configuration.GetConnectionString[connString].ConnectionString;
        ...
        {
            this.conString = this.Configuration.GetConnectionString(connString);  //ConfigurationManager.ConnectionStrings[connString].ConnectionString;
        }
